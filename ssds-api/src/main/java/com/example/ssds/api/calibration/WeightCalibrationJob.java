...
public class WeightCalibrationJob {
    ...
    public WeightCalibrationJob(CalibrationReportRepository reports,SceneClassificationLogRepository scenes,WeightCalibrationService service){
        this.reports=reports;this.scenes=scenes;this.service=service;}
    ...
    public void run(){
        ...
        LocalDate today=now.toLocalDate();int quarter=(today.getMonthValue()-1)/3+1;
        String quarterCode=today.getYear()+"Q"+quarter;
