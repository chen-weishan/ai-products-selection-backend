...
// 取得單一關鍵字的 90 天歷史熱度折線圖
    ...
    public List<TrendChartProjection> getTrendChart(@PathVariable("keywordId") Long keywordId) {
        return trendService.getTrendChart(keywordId);
    }

// 取得單一關鍵字趨勢明細
    @GetMapping("/{keywordId}/detail")
    public TrendDetailResponse getTrendDetail(@PathVariable("keywordId") Long keywordId) {
