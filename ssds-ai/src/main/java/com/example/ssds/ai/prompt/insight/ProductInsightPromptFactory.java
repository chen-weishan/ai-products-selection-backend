...
public class ProductInsightPromptFactory {
    public static final String PROMPT_VERSION = "product-insight-v4";
    ...
    public String retryInstruction(String validationCode) {
        return """
                ...
                1. 根物件只能包含 sellingPoints、risks，兩個陣列都必須各有 2 至 4 筆且內容不可重複。
                ...
                4. type、severity 必須使用規定列舉；countedInPenalty 必須與 INPUT_JSON.penalties 的正值及命中主題一致。
                5. 文字中的數字只能原樣引用 INPUT_JSON 或該筆 supportCount，不得產生其他數字。
